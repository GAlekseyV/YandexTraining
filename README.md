# Решения домашних заданий с тренировок по алгоритмам 2.0

[Тренировки по алгоритмам 2.0](https://yandex.ru/yaintern/algorithm-training#schedule)

## Домашнее задание 1. Дивизион B

- [A. Interactor](/src/HW_B1/Task_A/task_A.md)
- [B. Кольцевая линия метро](src/HW_B1/Task_B/task_B.md)
...
## Домашнее задание 3. Дивизион В

- [А. Количество совпадающих](/src/HW_B3/Task_A/task_A.md)
- [B. Встречалось ли число раньше](/src/HW_B3/Task_B/task_B.md)
